  ...
  <div class="panel panel-left">
    ...
    <div class="panel-body" id="officeContainer" style="padding:0">
      ${config.starOfficeUrl || config.starOfficePublicUrl
        ? `<iframe class="office-frame" id="officeFrame" src="/office/" allow="clipboard-write" loading="eager"></iframe>`
...
<div class="toolbar">
  ...
  ${(config.starOfficePublicUrl || config.starOfficeUrl) ? `<a class="toolbar-link" href="/office/" target="_blank">Office</a>` : ''}
...
const OFFICE_URL = ${(config.starOfficePublicUrl || config.starOfficeUrl) ? `"/office"` : "null"};
let ws = null;
let feedCount = 0;
